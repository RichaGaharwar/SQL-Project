...
-- Count of Cities & States of customers who ordered during the given period
...
-- Impact on Economy: Analysis of the money movement by e-commerce, looking at order prices, freight and others.
...
-- Also, the difference (in days) between the estimated & actual delivery date of an order.
...
--Tthe top 5 states with the highest & lowest average freight value
